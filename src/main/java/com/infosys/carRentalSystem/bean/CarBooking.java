...
public class CarBooking {
		...
		public CarBooking(Long bookingId, String username, String carNumber, String variantId, String fromDate,
				String toDate, Double totalPayment, Double advancePayment, Double pendingPayment, Boolean status) {
			super();
			this.bookingId = bookingId;
